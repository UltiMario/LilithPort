...
typedef enum {
	...
	PH_REQ_LIST,         // 2:ID 0�őS����
	PH_RES_LIST,         // 2:ID 1:name_l n:name 1:comment_l n:comment 1:state 4:IP 2:Port + �Í�
	PH_NEW_MEMBER,       // ��Ɠ���
	PH_QUIT,             // 2:ID
	PH_LOST,             // 2:ID
	...
	PH_DICE,             // 1:value
	PH_REQ_VS,           // 2:ID 4:���s�t�@�C���̃n�b�V��
	PH_RES_VS,           // 1:state
	PH_REQ_VS_PING,      // 1:ID 5�o����send
	PH_RES_VS_PONG,      // 1�b�Ԃ�4�ȏ��M�őΐ�J�n
	PH_REQ_VS_SETTING,   // 1:delay local��host�ő傫�Ȓl�ɂ��킹��
	PH_RES_VS_SETTING,   // 1:delay 4:seed 1:max_stage 1:stage 1:round 1:timer
	PH_VS_DATA,          // 4:frame n:data 4*delay�����M
	PH_REQ_VS_DATA,      // 4:frame �p�P�b�g���ĂȂ��̂ŋً}�v��
	PH_RES_VS_DATA,      // 4:frame 2:input
	PH_VS_END,
	PH_REQ_WATCH,        // 2:ID
	PH_RES_WATCH,        // 1:state 2:P1ID 2:P2ID 4:seed 1:max_stage 1:stage 1:round 1:timer  state = 0:�ϐ�J�n 1�`:�ϐ�s��
	PH_WATCH_DATA,       // 4:frame 40:10�t���[�����̃f�[�^
	PH_WATCH_END,        // 2:ID �����̂Ɠ���ID�Ȃ�ϐ�I���A����ID�Ȃ烊�X�g����폜
	PH_SECRET,           // 1:type n:type���Ƃɂ��낢��
} MT_SP_PACKET_HEADER;
